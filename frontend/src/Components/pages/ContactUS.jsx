  ...
  return (
    <div className='contact-main-div'>
      <div className='talk-div'>
        ...
        <div >
        <input style={{marginLeft:"33px"}}  placeholder='Tell us about your project'></input>
        </div>
